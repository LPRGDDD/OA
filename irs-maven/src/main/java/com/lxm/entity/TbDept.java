...
public class TbDept {
    ...
    private TbDwinformation tbdwinformation;
    ...
    public TbDwinformation getTbdwinformation() {
		return tbdwinformation;
	}

	public void setTbdwinformation(TbDwinformation tbdwinformation) {
		this.tbdwinformation = tbdwinformation;
	}
