		...
		<form class="layui-form" id="form1" action="">
			...
			<div class="layui-form-item">
				<div class="layui-inline">
					<label class="layui-form-label"><span class="yan">*</span>申请时间</label>
					<div class="layui-input-inline">
						<input class="layui-input lxm" readonly="readonly"
							value="${list.syShen}" id="test1" name="sytime" type="text"
							style="height:35px" placeholder="yyyy-MM-dd" lay-verify="date">
					</div>
				</div>
			</div>
			<div class="layui-form-item">
						...
						<div class="layui-input-inline">
							<!--style="height:35px"  -->
							<input name="syreason" class="layui-input lxm" readonly="readonly"  value="${list.timeAddress}" type="text"
			...
			<div class="layui-form-item">
						...
						<div class="layui-input-inline">
							<!--style="height:35px"  -->
							<input name="syreason" class="layui-input lxm" readonly="readonly"  value="${list.syReason}" type="text"
								style="height:35px" placeholder="请输入" autocomplete="off"
								lay-verify="required" lay-verify="title">
						</div>
					</div>
				...
				<div class="layui-inline">
					...
					<div class="layui-input-inline">
						<input class="layui-input lxm" readonly="readonly"
							...
							id="test4" type="text" placeholder="HH:mm:ss" lay-verify="kaishi">
					</div>
				</div>
			</div>
			<div class="layui-form-item">
			...
			<div class="layui-form-item">
				<div class="layui-input-block">
					<button class="layui-btn" onclick="update()">通过</button>
