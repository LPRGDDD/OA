...
<title>My JSP 'GeRenShiWu.jsp' starting page</title>
...
<body>
	...
	<div class="layui-tab" lay-filter="test">
		<ul class="layui-tab-title">
			<li class="layui-this" lay-id="11">外出登记</li>
			<li lay-id="22">新建外出登记</li>
		</ul>
		<!--外出登记  -->
				...
				<form class="layui-form" id="form1" action="">
					...
					<div class="layui-form-item">
						<div class="layui-inline">
							...
							<div class="layui-input-inline">
								<input class="layui-input lxm" readonly="readonly" name="wctime"  style="height:35px" id="test4"
					...
					<div class="layui-form-item">
						<div class="layui-inline">
							...
							<div class="layui-input-inline">
								<input class="layui-input lxm" readonly="readonly"  name="wctimeend"  style="height:35px" id="test30"
					...
					<div class="layui-form-item">
						<div class="layui-inline">
							...
							<div class="layui-input-inline" style="width:100px;">
								<input  name="wctimeone" id="wctimeone"   class="layui-input" onfocus="shi()"  style="height:35px"
									type="text" placeholder="" autocomplete="off">
							</div>
							<div class="layui-form-mid">时</div>
							<div class="layui-input-inline" style="width:100px;height:35px;">
								<input name="wctimetwo" id="wctimetwo" class="layui-input"   style="height:35px"
									type="text" placeholder="" autocomplete="off">
							</div>
		...
		layui.use('layer', function() { //独立版的layer无需执行这一句
			...
			var active = {
				...
				offset : function(othis) {
					...
					layer.open({
						type : 1,
						offset : [ '200px', '100px' ], //具体配置参考：http://www.layui.com/doc/modules/layer.html#offset
						area : [ '500px', '300px' ],
