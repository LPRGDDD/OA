...
public class Talents {
    ...
    private String hrTalentsWorkdate;
    ...
    private String hrTalentsGraduate;
	...
	public String getHrTalentsWorkdate() {
		return hrTalentsWorkdate;
	}

	public void setHrTalentsWorkdate(String hrTalentsWorkdate) {
	...
	public String getHrTalentsGraduate() {
		return hrTalentsGraduate;
	}

	public void setHrTalentsGraduate(String hrTalentsGraduate) {
	...
	public Talents(Integer hrTalentsId, Integer hrPlanId, Plan plan, String hrTalentsName, String hrTalentsIdentity,
			...
			String hrTalentsRelation, String hrTalentsMall, String hrTalentsWorkdate, String hrTalentsHealth,
			String hrTalentsBackground, String hrTalentsDegree, String hrTalentsGraduate, String hrTalentsSchool,
