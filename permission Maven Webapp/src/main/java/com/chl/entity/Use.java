...
public class Use {
    ...
    public Integer getTbUserRoleId() {
        return tbUserRoleId;
    }

    public void setTbUserRoleId(Integer tbUserRoleId) {
        this.tbUserRoleId = tbUserRoleId;
    }
