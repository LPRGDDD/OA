...
public class PersonXc {
	/**
	 * 员工薪酬基数设置表
	 */
    private Integer personxcId;//员工薪酬基数编号
    ...
    private Integer personDeptStatus;//是否是部门上报

    private Integer personCwStatus;//是否是财务上报项
   /* 用户表*/
    private TbAdmin user;
	public Integer getPersonxcId() {
		return personxcId;
	}
	public void setPersonxcId(Integer personxcId) {
		this.personxcId = personxcId;
	}
	...
	public Integer getPersonDeptStatus() {
		return personDeptStatus;
	}
	public void setPersonDeptStatus(Integer personDeptStatus) {
		this.personDeptStatus = personDeptStatus;
	}
	public Integer getPersonCwStatus() {
		return personCwStatus;
	}
	public void setPersonCwStatus(Integer personCwStatus) {
		this.personCwStatus = personCwStatus;
	}
	...
	public PersonXc(Integer personxcId, Double personxcS1, Double personxcS2, Double personxcS3, Double personxcS4,
			Double personxcS5, Double personxcS6, Double personxcS7, Double personxcS8, Double personxcS9,
			Double personxcS10, Double personxcInsurejs, Double personxcYlinsure, Double personxcDwyl,
			Double personxcGryl, Double personxcYlbx, Double personxcDwMedical, Double personxcGrmedical,
			Double personxcGroup, Double personxcDwsy, Double personxcSybx, Double personxcDwshiye, Double personxcGrsy,
			Double personxcGsbx, Double personxcDwgs, Double personxcHousingfund, Double personxcDwzf,
			Double personxcGrzf, String personxcExpression, Integer personDeptStatus, Integer personCwStatus,
			TbAdmin user) {
		super();
		this.personxcId = personxcId;
		this.personxcS1 = personxcS1;
	...
	public String toString() {
		return "PersonXc [personxcId=" + personxcId + ", personxcS1=" + personxcS1 + ", personxcS2=" + personxcS2
				+ ", personxcS3=" + personxcS3 + ", personxcS4=" + personxcS4 + ", personxcS5=" + personxcS5
				+ ", personxcS6=" + personxcS6 + ", personxcS7=" + personxcS7 + ", personxcS8=" + personxcS8
				+ ", personxcS9=" + personxcS9 + ", personxcS10=" + personxcS10 + ", personxcInsurejs="
				+ personxcInsurejs + ", personxcYlinsure=" + personxcYlinsure + ", personxcDwyl=" + personxcDwyl
				+ ", personxcGryl=" + personxcGryl + ", personxcYlbx=" + personxcYlbx + ", personxcDwMedical="
				+ personxcDwMedical + ", personxcGrmedical=" + personxcGrmedical + ", personxcGroup=" + personxcGroup
				+ ", personxcDwsy=" + personxcDwsy + ", personxcSybx=" + personxcSybx + ", personxcDwshiye="
				+ personxcDwshiye + ", personxcGrsy=" + personxcGrsy + ", personxcGsbx=" + personxcGsbx
				+ ", personxcDwgs=" + personxcDwgs + ", personxcHousingfund=" + personxcHousingfund + ", personxcDwzf="
				+ personxcDwzf + ", personxcGrzf=" + personxcGrzf + ", personxcExpression=" + personxcExpression
				+ ", personDeptStatus=" + personDeptStatus + ", personCwStatus=" + personCwStatus + ", user=" + user
				+ "]";
	}
