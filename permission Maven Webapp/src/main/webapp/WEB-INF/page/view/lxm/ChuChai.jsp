				...
				<form class="layui-form" id="form1" action="">
					<div class="layui-form-item">
						...
						<div class="layui-input-inline">
							<!--style="height:35px"  -->
							<input name="timeaddress" class="layui-input lxm" type="text"
...
layui.use('table', function(){
  ...
  table.render({
    elem: '#test'
    ,url:'WaiChu/ChuChaiSel'
    ,where:{
    	id:num
    }
    ,cols:[[
      {field:'username', width:120, title: '出差人员'}
      ,{field:'syShen', width:120, title: '申请时间',sort: true}
      ,{field:'shenname', width:120,title: '审批人员'}
      ,{field:'syReason', width:120, title: '出差内容'}
      ,{field:'timeAddress', width:120, title: '出差地点'}
  ...
  table.on('tool(demo)', function(obj){
    ...
    if(obj.event === 'detail'){
     ...
     layer.open({
            ...
            area: ['40%','90%'],
            offset: ['30px', '550px'],
            content:"http://localhost:8080/oa/WaiChu/ChuChaiUpdate/"+data.sId+"/"+data.id
        });
