		...
		<form class="layui-form" id="form1" action="">
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<!--style="height:35px"  -->
					<input name="syreason" class="layui-input lxm" type="text"
						style="height:35px" placeholder="请输入" readonly="readonly" value="${list.timeAddress}"
						autocomplete="off" lay-verify="required" lay-verify="title">
				</div>
			</div>
			<div class="layui-form-item">
				<label class="layui-form-label"><span class="yan">*</span>出差内容</label>
				<div class="layui-input-inline">
					<!--style="height:35px"  -->
					<input name="syreason" class="layui-input lxm" type="text"
				...
				<div class="layui-inline">
					...
					<div class="layui-input-inline">
						<input class="layui-input lxm" readonly="readonly"
							value="${list.syShen}" name="wctime" style="height:35px"
